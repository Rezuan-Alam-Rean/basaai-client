...
export function ListerDashboard() {
  ...
  const isMyListingsPage = pathname === "/lister/my-listings";
            ...
            <>
              <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Review and manage every listing you have posted.</p>
                </div>
                <Link href="/add-listing">
                  <Button className="bg-primary hover:bg-primary/90">Post New Listing</Button>
                </Link>
              </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                {[
                  ...
                  { label: "Active", value: listings.filter((listing) => listing.status === "Active").length.toString() },
                  { label: "Pending Review", value: listings.filter((listing) => listing.status === "Under Review").length.toString() },
                  { label: "Paused", value: listings.filter((listing) => listing.status === "Paused").length.toString() },
                ].map((s) => (
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between gap-3 mb-4">
                  <h2 className="text-lg font-semibold tracking-tight">Listing Management</h2>
                  <p className="text-xs text-muted-foreground">Edit, pause, or delete listings from one place.</p>
                </div>
